...
{
    public class EquineFeedReviewModel : PageModel
    {
        private readonly EquineFinancialContext _context;

        public EquineFeedReviewModel(EquineFinancialContext context)
        {
            _context = context;
        }
